...
driver.navigate.to "http://spezicoe.wipro.com:81/opencart1/"
...
driver.find_element(:name,"email").send_keys("ak@w.com")
driver.find_element(:name,"password").send_keys("qwerty@123")
