Feature: Opencart Application TC02
  Scenario: Product Comparison
    ...
    And I passed "ak@w.com" Login
    And I passed "qwerty@123" password
    ...
    And I passed "Akansha" first name in the Billing Details
    And I passed "Ag" second name in the billing Details
    And I passed "12-a" address in the billing Details
    And I passed "Bangalore" city in the billing Details
    And I passed "560001" post code in the billing Details
    And I select "India" from "country_id" combo1
    And I select "Karnataka" from "zone_id" combo1
